...
export interface ApiBookmarkedJobofferBookmarkedJoboffer
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    jobOffer: Schema.Attribute.Relation<'oneToOne', 'api::job-offer.job-offer'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCompanyCompany extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    hasFreeJobPosts: Schema.Attribute.Boolean &
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    size: Schema.Attribute.Enumeration<['micro', 'small', 'medium', 'large']> &
...
export interface ApiJobOfferJobOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    remoteOptions: Schema.Attribute.Enumeration<
      ['noRemote', 'fullRemote', 'hybrid']
    >;
    salaryFrom: Schema.Attribute.String;
    salaryTo: Schema.Attribute.String;
    seniorityLevel: Schema.Attribute.Enumeration<
...
export interface ApiLearnCategoryLearnCategory
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::learn-category.learn-category'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    resources: Schema.Attribute.Relation<
      'oneToMany',
      'api::learn-resource.learn-resource'
    >;
...
export interface ApiLearnResourceLearnResource
  extends Struct.CollectionTypeSchema {
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    snippets: Schema.Attribute.Relation<'manyToMany', 'api::snippet.snippet'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
